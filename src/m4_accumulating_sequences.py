...
def main():
    ...
    # ------------------------------------------------------------------
    # 8: DONE Uncomment the tests below before working TO DO 9.
...
def draw_shapes(shapes, window):
    ...
    """
    # ------------------------------------------------------------------
    # 9: DONE Implement and test this function. Make sure you do TO DO 8 in main first!
...
def rectangles_from_circles(circles):
    ...
    for circle in circles:
        ...
        point1 = rg.Point(center.x - radius, center.y - radius)
        point2 = rg.Point(center.x + radius, center.y + radius)
